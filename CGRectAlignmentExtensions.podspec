#
#  Be sure to run `pod spec lint CGRectAlignmentExtensions.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Marco"
  # s.authors            = { "Marco" => "mj.jonker@live.nl" }
  # s.social_media_url   = "http://twitter.com/Marco"
